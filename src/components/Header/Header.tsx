	...
	const Header = () => {
		...
		const sidebarStyle = openMenu ? {"left" : "0", "transition": "0.6s all"} : {"left" : "-110%", "transition": "0.6s all"};
		openMenu || click ? document.body.style.overflow = "hidden" : document.body.style.overflow = "auto";
		const hamburger = (
